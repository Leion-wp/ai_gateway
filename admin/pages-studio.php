...
function ai_gateway_render_studio_admin_page() {
    ...
    <style>
        ...
        .ai-studio-admin .ai-studio-app { display: grid; grid-template-columns: 280px 1fr; gap: 16px; min-height: 80vh; }
        ...
        .ai-studio-admin .ai-studio-conversation { text-align: left; background: #1f2430; color: #e5e7eb; border: 1px solid #2c313c; border-radius: 12px; padding: 10px; cursor: pointer; }
        ...
        .ai-studio-admin .ai-studio-composer-row { display: flex; align-items: center; gap: 12px; background: #171a21; border-radius: 14px; padding: 12px; border: 1px solid #262b36; }
